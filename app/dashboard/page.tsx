...
import { Zap, TrendingUp, TrendingDown, Power, Lightbulb, Tv, Wind, Thermometer, Wifi, WifiOff } from "lucide-react"
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem className="hidden md:block">
                <BreadcrumbLink href="#">Energy Dashboard</BreadcrumbLink>
              </BreadcrumbItem>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">4 devices offline</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          ...
          <Card className="col-span-3">
            <CardHeader>
              ...
              <CardDescription>Current power usage by device</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={350}>
